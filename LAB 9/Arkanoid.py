...
def main_menu():
    ...
    subtitle_text = subtitle_font.render("by Sabyrzhan Olzhas", True, (255, 255, 255))
    ...
    while True:
        ...
        screen.blit(subtitle_text, (W // 2 - subtitle_text.get_width() // 2, H // 4 + title_text.get_height() // 2 + 10))
...
def settings_menu():
    ...
    while True:
        ...
        screen.blit(settings_title, (W // 2 - settings_title.get_width() // 2, H // 4 - settings_title.get_height() // 2))
...
#Timer (Runs in main menu, dont have time to fix Sorry (◞‸◟ㆀ) )
...
#Catching sound
collision_sound = pygame.mixer.Sound('media for Ackanoid/catch.mp3')
...
while not done:
    ...
    while playing:
        ...
        for special_color, special_block in special_list:
            ...
            pygame.draw.polygon(screen, (255-special_color[0], 255-special_color[1], 255 - special_color[2]), (coordines_star(special_block.center)), 0)
        ...
        for unbreakable_color, unbreakable_block in unbreakable_list:
            ...
            pygame.draw.line(screen, (255 - unbreakable_color[0], 255 - unbreakable_color[1], 255 - unbreakable_color[2]), unbreakable_block.topleft, unbreakable_block.bottomright, width=3)
            pygame.draw.line(screen, (255 - unbreakable_color[0], 255 - unbreakable_color[1], 255 - unbreakable_color[2]), unbreakable_block.bottomleft, unbreakable_block.topright, width=3)
            pygame.draw.line(screen, (255 - unbreakable_color[0], 255 - unbreakable_color[1], 255 - unbreakable_color[2]), unbreakable_block.topright, unbreakable_block.bottomright, width=3)
            pygame.draw.line(screen, (255 - unbreakable_color[0], 255 - unbreakable_color[1], 255 - unbreakable_color[2]), unbreakable_block.topleft, unbreakable_block.bottomleft, width=3)
            pygame.draw.line(screen, (255 - unbreakable_color[0], 255 - unbreakable_color[1], 255 - unbreakable_color[2]), unbreakable_block.bottomleft, unbreakable_block.bottomright, width=3)
            pygame.draw.line(screen, (255 - unbreakable_color[0], 255 - unbreakable_color[1], 255 - unbreakable_color[2]), unbreakable_block.topleft, unbreakable_block.topright, width=3)
